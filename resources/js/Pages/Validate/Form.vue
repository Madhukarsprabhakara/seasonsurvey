 ...
 <!--  <form>
  ...
  <div>
    ...
    <template #item="{element}">
      <div class="flex items-center gap-x-3"><input id="push-everything" name="push-notifications" type="radio" class=" h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600" /><label class="cursor-move">{{element.name}}</label></div>
